        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-slate-50 p-8 rounded-2xl shadow-lg">
            <div className="relative h-96 rounded-xl overflow-hidden shadow-md">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1073.3827582006918!2d72.80826291747022!3d19.380665829124844!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7af002197a051%3A0xec5bb1d2129a77c9!2sInnocent%20Memorial%20Centre!5e0!3m2!1sen!2sin!4v1754707799968!5m2!1sen!2sin"
                width="600"
                height="450"
                style={{ border: 0 }}
                allowFullScreen=""
            ...
            <div className="flex gap-3 mt-4">
              <a
                 href="https://maps.app.goo.gl/z3TwkmArmzJw5qtU9"
                target="_blank"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-xl shadow-sm">
              ...
              <p className="text-slate-600">
                Easy access via Vasai-Virar road. Free parking available on
                premises.
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-sm">
              ...
              <p className="text-slate-600">
                Nearest station: Vasai Road. Short auto/cab ride to the venue.
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-sm">
              ...
              <p className="text-slate-600">
                Regular bus service available. Multiple bus stops nearby.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-slate-800 text-white rounded-xl">
            ...
            <p className="text-slate-300">
              Comfortable indoor environment for all weather conditions
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-slate-800 text-white rounded-xl">
            ...
            <p className="text-slate-300">
              Regulation size court with high-quality equipment
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-slate-800 text-white rounded-xl">
            ...
            <p className="text-slate-300">
              LED lighting, proper ventilation, and safety features
            </p>
          </div>
        </div>
      </div>
